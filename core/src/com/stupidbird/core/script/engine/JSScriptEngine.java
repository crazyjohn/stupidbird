package com.stupidbird.core.script.engine;
 ...
 *
 */
public class JSScriptEngine implements GameScriptEngine {
	 ...
	 *            脚本默认的字符编码
	 */
	public JSScriptEngine(String charset) {
	...
	public Object runScript(Map<String, Object> binding, String scriptFile,
		...
		try {
			...
			throw new RuntimeException(content, se);
		}
	}
	...
	public String getScriptContent(String scriptFile, String charset) {
		try {
			return FileUtils.readFileToString(new File(scriptFile),
					charset != null ? charset : this.charset);
		} catch (IOException e) {
			throw new RuntimeException(scriptFile, e);
		}
